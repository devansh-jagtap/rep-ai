        ...
        <section className="bg-background @container py-24">
            <div className="mx-auto max-w-2xl px-6">
                <Card
                    ...
                    <div>
                        <h2 className="text-balance font-serif text-3xl font-medium">Deploy your AI agent today</h2>
                        <p className="text-muted-foreground mt-3 text-balance">Stop missing out on potential clients while you sleep. Let your personal AI representative handle the introduction.</p>
